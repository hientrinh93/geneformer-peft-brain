...
def main():
    ...
    # Load label mapping if exists, or detect from train data
    train_dataset, _, _ = load_and_tokenize_data(config)  # reuse to get label mapping
    label_col = "label"
    ...
    _, _, test_dataset = load_and_tokenize_data(config)   # already tokenized
